                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <form id='form-account' onSubmit={handleSubmit}>
                                                ...
                                                <div className="form-row">
                                                    <div className="form-group col-md-6">
                                                        <label htmlFor="feJoinDate">Join Date</label>
                                                        <input type="date" className="form-control" id="feJoinDate" placeholder="" name='joinDate'
                                                            value={profileData.joinDate ? profileData.joinDate.split('-')[0].length < 4 ? stringToDate(profileData.joinDate.split(' ')[0]) : profileData.joinDate.split(' ')[0] : profileData.joinDate} onChange={(event) => setProfileData({ ...profileData, [event.target.name]: event.target.value + " 00:00:00" })} />
                                                    </div>
                                                    <div className="form-group col-md-6">
                                                        <label htmlFor="felocale">Locale</label>
                                                        <input type="text" className="form-control" id="felocale" placeholder="Locale" name='locale'
                                                            value={profileData.locale} onChange={(event) => setProfileData({ ...profileData, [event.target.name]: event.target.value })} />
                                                    </div>
                                                </div>
                                                <div className="form-row">
                                                    <div className="form-group col-md-6">
