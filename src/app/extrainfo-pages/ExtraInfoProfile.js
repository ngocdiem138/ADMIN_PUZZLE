...
const ExtraInfoProfile = () => {
    ...
    useEffect(() => {
        extraInfoService.getOneExtraInfo(params.id).then(response => {
            if (response.data.errCode == "403") {
            } else {
                setExtraInfoProfileData(response.data.data);
            }
        }
        )
                    ...
                    <div className="card-body">
                        ...
                        <form className="form-sample" onSubmit={handleSubmit}>
                            ...
                            <div className="row">
                                ...
                                <div>
                                    <button className="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type='submit'>Update Extra Information</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
export default ExtraInfoProfile
