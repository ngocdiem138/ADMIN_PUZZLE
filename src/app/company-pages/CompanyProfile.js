                        ...
                        <div className="card card-small mb-4 pt-3">
                            <div className="card-header border-bottom text-center">
                                <div className="mb-3 mx-auto" id="image-company">
                                    {companyProfileData.image !== undefined ? <CardProfile url={(!companyProfileData.image) ? ImageNoAvatar : companyProfileData.image} parentCallback={callbackFunction} /> : ''}
                                </div>
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <form id='form-account' onSubmit={handleSubmit}>
                                                ...
                                                <div className="form-row">
                                                    <div>
                                                        <button className="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type='submit'>Update Company</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
